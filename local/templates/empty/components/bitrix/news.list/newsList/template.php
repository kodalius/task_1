...
<link rel="stylesheet" href="/local/templates/empty/components/bitrix/news.list/newsList/build/css/common.css">

<div id="barba-wrapper">
    <div class="article-list"><a class="article-item article-list__item" href="for-individuals.html"
                                 data-anim="anim-3">
            <div class="article-item__background"><img src="/local/templates/empty/components/bitrix/news.list/newsList/build/images/article-item-bg-6.jpg"
            ...
            <div class="article-item__background"><img src="/local/templates/empty/components/bitrix/news.list/newsList/build/images/article-item-bg-3.jpg"
            ...
            <div class="article-item__background"><img src="/local/templates/empty/components/bitrix/news.list/newsList/build/images/article-item-bg-4.jpg"
            ...
            <div class="article-item__background"><img src="/local/templates/empty/components/bitrix/news.list/newsList/build/images/article-item-bg-5.jpg"
            ...
            <div class="article-item__background"><img src="/local/templates/empty/components/bitrix/news.list/newsList/build/images/article-item-bg-2.jpg"
            ...
            <div class="article-item__background"><img src="/local/templates/empty/components/bitrix/news.list/newsList/build/images/article-item-bg-1.jpg"
